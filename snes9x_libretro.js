...
var wasmMemory;
var wasmTable = new WebAssembly.Table({ initial: 6222, maximum: 6222 + 0, element: "anyfunc" });
var ABORT = false;
var EXITSTATUS = 0;
...
var DYNAMIC_BASE = 8117360,
    DYNAMICTOP_PTR = 2874320;
...
function __registerKeyEventCallback(target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) {
    ...
    var eventHandler = { target: __findEventTarget(target), allowsDeferredCalls: true, eventTypeString: eventTypeString, callbackfunc: callbackfunc, handlerFunc: keyEventHandlerFunc, useCapture: useCapture };
    JSEvents.registerOrRemoveHandler(eventHandler);
}
...
var ___tm_current = 2874336;
var ___tm_timezone = (stringToUTF8("GMT", 2874384, 4), 2874384);
function _tzset() {
